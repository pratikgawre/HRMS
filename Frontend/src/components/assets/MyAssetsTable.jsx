            ...
            {rows.map((asset) => {
              ...
              return (
                <tr key={asset.id}>
                  ...
                  <td data-label="Current Date">{asset.currentDate || asset.assignedDate || '-'}</td>
                  <td data-label="Due Date">{asset.dueDate || '-'}</td>
                  <td data-label="Employee ID">{asset.assignedToEmployeeId || '-'}</td>
